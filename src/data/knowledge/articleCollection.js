  ...
  categories: {
    ...
    selfDevelopment: {
      ...
      articles: [
        ...
        {
          articleTitle: '面对人生重大选择犹豫不决？决策心理学教你打破"分析瘫痪"',
          source: { platform: '壹心理', author: '决策心理学研究者王博士', url: '' },
          publishDate: '2025-03',
          readCount: '11万+',
          tags: ['决策困难', '分析瘫痪', '选择焦虑', 'ACT', '意义感'],
          summary: '过度分析反而导致决策瘫痪，学会"足够好"决策策略打破选择困境',
          coreInsights: [
            { insight: '"分析瘫痪"是决策者的典型困境——信息越多，决策越难', evidence: 'Schwartz(2004)选择悖论研究：选项超过一定数量后，满意度下降、决策延迟增加', practicalMeaning: '不是信息不够，是信息太多让你无法决策' },
            { insight: '追求"最优解"的人比追求"满意解"的人更不快乐', evidence: 'Schwartz最大化者研究：最大化者(追求最优)比满意者(追求足够好)决策后更后悔、更不满足', practicalMeaning: '"足够好"的选择比"最好"的选择更让你幸福' },
            { insight: '人生的重大决策没有"正确"答案，只有"当下最适合"的选择', evidence: '存在主义心理学：意义不是找到的，而是在选择和行动中建构的', practicalMeaning: '选择的意义不在于选对，而在于选择后你如何赋予它意义' }
          ],
          practicalTips: [
            { tip: '"足够好"决策法', steps: ['明确你的核心需求（不超过3个）', '设定"足够好"的最低标准', '第一个满足标准的选项就选它', '停止继续搜索更多选项', '接受"没有完美选择"'], difficulty: '中等', estimatedTime: '每次决策' },
            { tip: '决策后意义建构练习', steps: ['做出选择后，写下选择它的3个理由', '不要去想"如果选另一个会怎样"', '专注于如何让这个选择变得有意义', '定期回顾：这个选择教会了我什么'], difficulty: '中等', estimatedTime: '15分钟' }
          ],
          warmPhrases: [
            { phrase: '人生没有"正确"答案，只有你选择后赋予的意义', scenario: '用户因重大决策而焦虑时', tone: '温和' },
            { phrase: '选哪一个没那么重要，重要的是选择后你如何走下去', scenario: '用户反复纠结选择时', tone: '坚定' },
            { phrase: '"足够好"的选择比"最好"的选择更让你幸福', scenario: '用户追求完美决策时', tone: '温和' }
          ],
          aiIntegration: {
            applicableScenarios: ['用户说"我选不出来""我不知道怎么选"时', '用户面临重大人生决策时'],
            relatedModules: ['act', 'humanistic'],
            suggestedResponse: '我理解选择让你焦虑。但心理学研究发现一个反直觉的事实：选项越多，决策越难，满意度反而越低。追求"最优解"的人，比追求"足够好"的人更不快乐。试试"足够好"决策法：明确你的核心需求，设定最低标准，第一个满足的选项就选它。人生的重大决策没有"正确"答案，只有"当下最适合"的选择。选哪一个没那么重要，重要的是选择后你如何赋予它意义。'
          }
        }
      ]
    },
    ...
    stressAndResilience: {
      ...
      articles: [
        ...
        {
          articleTitle: '从创伤到成长：理解创伤后应激与创伤后成长的双重路径',
          source: { platform: '简单心理', author: '创伤心理治疗师李老师', url: '' },
          publishDate: '2025-01',
          readCount: '10万+',
          tags: ['创伤', '创伤后成长', 'PTSD', '复原力', '意义重建'],
          summary: '创伤经历同时触发痛苦与成长两条路径，理解双重性帮助整合而非回避',
          coreInsights: [
            { insight: '创伤后应激(PTSD)和创伤后成长(PTG)可以同时存在——不是非此即彼', evidence: 'Tedeschi & Calhoun(2004)研究：约50-70%的创伤幸存者同时报告了PTSD症状和积极成长', practicalMeaning: '痛苦和成长不是对立的，它们可以共存' },
            { insight: '创伤后成长的核心不是"忘记痛苦"，而是"在痛苦中重建意义"', evidence: 'Frankl意义疗法：人在极端痛苦中仍能找到意义，意义感是复原的核心驱动力', practicalMeaning: '不需要忘记或压抑创伤，而是找到它在你生命故事中的位置' },
            { insight: '社会支持是创伤恢复最强的预测因子——孤立比创伤本身更危险', evidence: 'Hobfoll(2007)资源保存理论：社会支持是创伤恢复最关键的资源', practicalMeaning: '不要一个人扛，允许他人陪伴你' }
          ],
          practicalTips: [
            { tip: '创伤叙事写作法', steps: ['找一个安全的时间和空间', '写下你的创伤经历（不需要一次写完）', '写下它对你的影响', '尝试写下：因为这件事，我发现了自己什么力量？', '不追求"积极"，真实就好'], difficulty: '需要勇气', estimatedTime: '15-30分钟/次' },
            { tip: '安全连接建立法', steps: ['列出3个让你感到安全的人', '每天至少和其中1人联系', '不需要谈创伤，只是保持连接', '允许自己接受帮助'], difficulty: '简单', estimatedTime: '5-10分钟' }
          ],
          warmPhrases: [
            { phrase: '创伤后的成长不是"忘了痛苦"，而是在痛苦中找到继续前行的力量', scenario: '用户因创伤而自责时', tone: '温和' },
            { phrase: '你不必一个人扛——社会支持是创伤恢复最强的预测因子', scenario: '用户孤立自己时', tone: '坚定' },
            { phrase: '痛苦和成长可以同时存在，它们不是对立的', scenario: '用户觉得"不应该痛苦"时', tone: '共情' }
          ],
          aiIntegration: {
            applicableScenarios: ['用户提及创伤经历时', '用户因创伤而自我隔离时'],
            relatedModules: ['mindfulness', 'selfHelpToolkit', 'act'],
            suggestedResponse: '我听到你经历了很艰难的事情。创伤后应激和创伤后成长可以同时存在——不是非此即彼。约50-70%的创伤幸存者同时报告了PTSD症状和积极成长。创伤恢复的核心不是"忘记痛苦"，而是"在痛苦中重建意义"。试试创伤叙事写作：找一个安全的时间和空间，写下你的经历和它对你的影响。不需要一次写完，也不需要追求"积极"，真实就好。社会支持是创伤恢复最强的预测因子——不要一个人扛。'
          }
        }
      ]
    },
    sleepAndHealth: {
      ...
      articles: [
        ...
        {
          articleTitle: '睡眠卫生的7个黄金法则：为什么你"什么都做了"还是睡不好',
          source: { platform: '壹心理', author: '睡眠医学专家刘医生', url: '' },
          publishDate: '2025-06',
          readCount: '15万+',
          tags: ['睡眠卫生', '失眠', '昼夜节律', '蓝光', '睡眠环境'],
          summary: '睡眠卫生不仅是"早睡早起"，7个被忽视的关键细节决定睡眠质量',
          coreInsights: [
            { insight: '睡眠不是"关掉开关"，而是"让大脑降速"的过程——需要90分钟的过渡期', evidence: '睡眠医学研究：睡前90分钟是"睡眠准备窗口"，此时的光线、活动、饮食直接影响入睡速度和睡眠深度', practicalMeaning: '睡前90分钟做什么，比几点上床更重要' },
            { insight: '蓝光不是唯一的问题——"床上看手机"最大的问题是破坏了"床=睡觉"的条件反射', evidence: 'Bootzin刺激控制理论：床和睡眠之间的条件反射是睡眠卫生的核心机制', practicalMeaning: '床只用来睡觉，不在床上看手机、工作、吃饭' },
            { insight: '周末补觉不能弥补平时睡眠不足——睡眠节律的一致性比睡眠时长更重要', evidence: 'Wittmann(2006)社会时差研究：周末和平时睡眠时间差超过2小时，相当于每周经历一次"时差"', practicalMeaning: '固定起床时间（包括周末）比多睡更重要' }
          ],
          practicalTips: [
            { tip: '90分钟睡前过渡法', steps: ['设定目标入睡时间', '提前90分钟开始过渡', '前60分钟：停止工作、调暗灯光', '前30分钟：放下手机、做放松活动', '前15分钟：上床、深呼吸、准备入睡'], difficulty: '需要坚持', estimatedTime: '90分钟过渡' },
            { tip: '睡眠环境优化清单', steps: ['温度：18-22°C（凉爽比温暖更助眠）', '光线：完全黑暗或使用眼罩', '声音：白噪音或完全安静', '床垫：支撑性适中', '枕头：高度适合你的睡姿'], difficulty: '简单', estimatedTime: '一次性优化' }
          ],
          warmPhrases: [
            { phrase: '睡眠不是"关掉开关"，而是"让大脑降速"的过程——给自己90分钟过渡期', scenario: '用户因睡不着而焦虑时', tone: '温和' },
            { phrase: '周末补觉不能弥补平时睡眠不足，但固定起床时间可以', scenario: '用户靠周末补觉时', tone: '坚定' },
            { phrase: '床只用来睡觉——不在床上看手机、工作、吃饭', scenario: '用户在床上看手机时', tone: '温和' }
          ],
          aiIntegration: {
            applicableScenarios: ['用户说"我睡不好""什么都试了还是睡不着"时', '用户描述不良睡眠习惯时'],
            relatedModules: ['cbt', 'mindfulness'],
            suggestedResponse: '我理解你睡不好的困扰。但睡眠卫生不只是"早睡早起"——睡眠是"让大脑降速"的过程，需要90分钟的过渡期。睡前90分钟做什么，比几点上床更重要。更重要的是：床只用来睡觉，不在床上看手机、工作、吃饭。如果20分钟睡不着就起来做放松的事，困了再回床上。固定起床时间（包括周末）比多睡更重要。试试给自己90分钟的睡前过渡期。'
          }
        }
      ]
    }
